...
import { TrendingUp, BarChart3, Users, Settings, LogOut, Menu, X, Activity } from "lucide-react"
...
export function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    const navItems = [
        ...
        { icon: Activity, label: "Assessments", href: "/admin/assessments" },
            ...
            >
                <div className="p-6 border-b border-border flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <span className="font-bold text-foreground text-sm">CreditFlow</span>
